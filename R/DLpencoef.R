...
#' @param lh sequence of threshold values across lag.max. Could be a single value (repeated for all lag.max), a single vector of length lag.max (repeated for all nser), or a lag.max x nser matrix. Default is data driven.
